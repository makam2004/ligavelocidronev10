...
// === Static frontend served from ../frontend (Render Arreglo A) ===
const staticDir = path.resolve(__dirname, '../frontend');
if (!fs.existsSync(staticDir)) {
  console.error('[FATAL] Static dir not found:', staticDir);
}
if (!fs.existsSync(path.join(staticDir, 'index.html'))) {
  console.error('[FATAL] index.html not found at:', path.join(staticDir, 'index.html'));
}
